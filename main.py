...
from GetLoginData_pb2 import GetLoginData
from MajorLogin_pb2 import MajorLoginRes
...
class FF_CLIENT:
    ...
    async def Main(self):
        Uid = '4776456016'; Password = '0049F2DB346A8BD61A99DD1635E0526905A3D8AD9AFE230973FC93A49E3B25D2'
        ...
        try:
            ...
            print(render('MASTR', colors=['white', 'red'], align='center'))
        except:
            print("=== FF LEVEL UP BOT ===")
